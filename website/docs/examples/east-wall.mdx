...
<BetaPlayground
  title="The east wall — live"
  args={[
    {id: 'A', label: 'Alice (military): fortify the east'},
    {id: 'B', label: 'Bob (logistics): abandon the east'},
  ]}
  attacks={[{from: 'B', to: 'A', weight: 0.4}]}
  initialBeta={0}
/>

Two arguments, one directed weighted attack. The attack weight is **0.4** — strong enough that Bob's logistics objection undermines Alice's strategic case at low β, but droppable once β reaches 0.4. The slider above runs the real `argumentation` engine compiled to WebAssembly — every drag recomputes credulous acceptance in your browser.
...
<BetaSlider
  title="The east wall across β"
  tracePaths={[
    {beta: 0.0, path: '/traces/east-wall-b00.json'},
    {beta: 0.4, path: '/traces/east-wall-b04.json'},
    {beta: 0.5, path: '/traces/east-wall-b05.json'},
    {beta: 1.0, path: '/traces/east-wall-b10.json'},
  ]}
/>
