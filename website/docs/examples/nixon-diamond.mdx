...
<AttackGraph
  ...
  caption="Symmetric mutual attack. Grounded semantics leaves both undecided; preferred semantics picks one or the other — the framework alone cannot decide between them."
/>
