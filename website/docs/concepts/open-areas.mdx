...
- [Value-based argumentation (VAF)](/concepts/value-based-argumentation) — the implemented formalism that was previously the headline open area.
- [Reading order](/academic/reading-order) — the literature path that gets you to these formalisms.
- [Hal & Carla](/examples/hal-and-carla) — the engine-driven scene whose limitations motivated VAF.
